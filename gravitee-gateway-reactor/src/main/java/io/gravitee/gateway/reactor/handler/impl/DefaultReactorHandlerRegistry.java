...
public class DefaultReactorHandlerRegistry implements ReactorHandlerRegistry {
    ...
    private final Set<HandlerEntrypoint> entrypoints = new ConcurrentSkipListSet<>(new HandlerEntryPointComparator());
    ...
    public void update(Reactable reactable) {
        ...
        if (reactableEntrypoints != null) {
            ...
            if (newHandler != null) {
                ...
                entrypoints.removeIf(previousHandler.entrypoints::contains);
