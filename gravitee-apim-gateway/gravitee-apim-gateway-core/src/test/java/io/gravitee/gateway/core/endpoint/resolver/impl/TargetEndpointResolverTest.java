...
public class TargetEndpointResolverTest {
    ...
    public void shouldResolveUserDefinedEndpoint_withQueryParamsInTarget() {
        ...
        resolveUserDefinedEndpoint("http://host:8080/test", parameters, "local:", "local", "http://host:8080/test?endpointParam=v");
    }
    ...
    public void shouldResolveUserDefinedEndpoint_withQueryParamsInDynRout() {
        ...
        resolveUserDefinedEndpoint("http://host:8080/test", parameters, "local:?dynroutParam=v", "local", "http://host:8080/test");
    }
    ...
    private void resolveUserDefinedEndpoint(
        String expectedURI,
        MultiValueMap<String, String> expectedParameters,
