...
public class UserRepositoryMock extends AbstractRepositoryMock<UserRepository> {
    ...
    void prepare(UserRepository userRepository) throws Exception {
        ...
        when(userRepository.search(argThat(o -> o != null && "DEFAULT".equals(o.getReferenceId())), any()))
        ...
        when(userRepository.findBySource("sourceSpecialChar", "sourceIdSpecialChar+test@me", "DEV", UserReferenceType.ENVIRONMENT))
